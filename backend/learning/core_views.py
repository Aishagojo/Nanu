...
# The old models (Course, Unit, Enrollment, FeeItem, etc.) have been replaced
# with Programme, CurriculumUnit, Registration, FeeStructure, etc.
# All views and logic in this file are now broken and must be rewritten.

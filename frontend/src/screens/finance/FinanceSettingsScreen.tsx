...
const settings = [
  { title: "Fee Items", description: "Add or edit tuition, therapy, transport items.", icon: "list" },
  { title: "Waivers", description: "Manage bursaries and special discounts.", icon: "pricetag" },
  { title: "Payment Plans", description: "Configure instalment schedules with reminders.", icon: "calendar" },
];

export const FinanceSettingsScreen: React.FC = () => (
  <ScrollView contentContainerStyle={styles.container}>
    <Text style={styles.title}>Finance Settings</Text>
    <Text style={styles.subtitle}>Control fee structures, waivers, and instalments in one place.</Text>
    {settings.map((item) => (

...
export const FinanceStudentsScreen: React.FC = () => (
  <ScrollView contentContainerStyle={styles.container}>
    ...
    <Text style={styles.subtitle}>Search, view receipts, and record new payments with a tap-friendly keypad.</Text>
    {ledgers.map((item) => (
      <View key={item.student} style={styles.card}>
        ...
        <View style={styles.cardBody}>
          ...
          <Text style={styles.cardMeta}>{item.balance} • {item.status}</Text>

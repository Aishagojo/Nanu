...
const fees = [
  { item: "Tuition Term 1", due: "KES 12,000", status: "Balance KES 4,000", color: palette.warning },
...
export const ParentFeesScreen: React.FC = () => (
  <ScrollView contentContainerStyle={styles.container}>
    ...
    <Text style={styles.subtitle}>Easily see balances, track payment plans, and set reminders.</Text>
    {fees.map((fee) => (
      <View key={fee.item} style={styles.card}>
        ...
        <View style={styles.cardBody}>
          ...
          <Text style={styles.cardMeta}>{fee.due} • {fee.status}</Text>

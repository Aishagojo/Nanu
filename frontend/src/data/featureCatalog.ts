...
export const featureCatalog: Record<Role, FeatureDescriptor[]> = {
  ...
  parent: [
    ...
    },
    {
      ...
      apiHint: 'GET /api/finance/students/<id>/summary/',
    },
    {
      key: 'messages',
      title: 'Messages',
  ...
  lecturer: [
    ...
    },
    {
      key: 'messages',
      title: 'Messages',
      description: 'Respond to parents and students with filters.',
    },
    {
      key: 'records',
      title: 'Records',
  ...
  hod: [
    ...
    },
    {
      ...
      description: 'Broadcast to lecturers, parents, or both.',
    },
    {
  ...
  finance: [
    ...
    },
    {
      key: 'users',
      title: 'Students',
      description: 'Search ledgers, record payments, highlight statuses.',
    },
    {
      key: 'messages',
      title: 'Invoices & Receipts',
      description: 'One-tap receipt generation and WhatsApp/SMS delivery.',
    },
    {
      key: 'alerts',
      title: 'Alerts',
      description: 'Schedule upcoming due reminders and bulk notifications.',
    },
    {
      key: 'settings',
      title: 'Settings',
  ...
  admin: [
    {
      key: 'users',
      title: 'Users & Roles',
      description: 'Create accounts, link parents, manage credentials.',
    },
    {
      key: 'settings',
      title: 'Systems',
  ...
  superadmin: [
    {
      ...
      description: 'Assign and revoke roles across the platform quickly.',
    },
    {
      key: 'analytics',
      title: 'Platform Health',
      description: 'Monitor adoption, login success, and MFA coverage.',
    },
    {
      key: 'settings',
    ...
    },
    {
      ...
      description: 'Download compliance-ready PDFs each quarter.',
    },
  ],
  librarian: [
    {
    ...
    },
    {
      ...
      description: 'See most-read resources and voice playback usage.',
    },
    {
      key: 'messages',
    ...
    },
    {
      ...
      description: 'Update opening hours, borrowing policies, and TTS voices.',
    },
    {
      key: 'reports',
